package fr.cel.skyfactionlauncher.ui.panels.pages;

import fr.cel.skyfactionlauncher.Launcher;
...
public class Login extends Panel {
    ...
    CheckBox authModeCheck = new CheckBox("Version Crack");
    ...
    public void init(PanelManager panelManager) {
        ...
        // CheckBox Crack
        setCanTakeAllSize(authModeCheck);
        setCenterV(authModeCheck);
        setCenterH(authModeCheck);
        authModeCheck.getStyleClass().add("login-mode-chk");
        authModeCheck.setMaxWidth(300);
        authModeCheck.setTranslateY(85d);
        authModeCheck.selectedProperty().addListener((e, old, newValue) -> {
        ...
        loginCard.getChildren().addAll(userField, userErrorLabel, passwordField, passwordErrorLabel, authModeCheck, btnLogin, separator, loginWithLabel, msLoginBtn);
    }
