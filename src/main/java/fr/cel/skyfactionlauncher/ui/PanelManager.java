package fr.cel.skyfactionlauncher.ui;

import fr.cel.skyfactionlauncher.Launcher;
import fr.cel.skyfactionlauncher.ui.panel.IPanel;
import fr.cel.skyfactionlauncher.ui.panels.partials.TopBar;
...
public class PanelManager {
    ...
    public void init() {
        this.stage.setTitle("SkyFaction Launcher");
        this.stage.setMinWidth(854);
        this.stage.setMinHeight(480);
        this.stage.setWidth(1280);
        this.stage.setHeight(720);
        this.stage.centerOnScreen();
        this.stage.getIcons().add(new Image("images/icon_32x32.png"));
