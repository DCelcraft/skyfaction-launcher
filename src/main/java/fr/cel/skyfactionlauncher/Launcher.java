package fr.cel.skyfactionlauncher;

import fr.cel.skyfactionlauncher.ui.PanelManager;
import fr.cel.skyfactionlauncher.ui.panels.pages.App;
import fr.cel.skyfactionlauncher.ui.panels.pages.Login;
...
public class Launcher extends Application {
    ...
    private final Path launcherDir = GameDirGenerator.createGameDir("skyfaction", true);
    ...
    public Launcher() {
        instance = this;
        this.logger = new Logger("[SF Launcher]", this.launcherDir.resolve("launcher.log"));
